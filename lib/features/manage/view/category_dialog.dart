...
class _CategoryDialogState extends State<CategoryDialog> {
  ...
  void initState() {
    ...
    if (widget.existing != null) {
      ...
      _selectedColor = parseHexColor(cat.color, fallback: const Color(0xFF6C63FF));
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Switch(
                      value: _goalIsActive,
                      onChanged: (v) => setState(() => _goalIsActive = v),
                    ),
                  ],
                ),
                if (_goalIsActive) ...[
                    ...
                    children: [
                      ...
                      TextButton.icon(
                        onPressed: () async {
                          final picked = await showDatePicker(
                            context: context,
                            initialDate: _goalDeadline ?? DateTime.now(),
                            firstDate:
                      ...
                      if (_goalDeadline != null)
                        IconButton(
                          ...
                          tooltip: '마감일 해제',
                          onPressed: () => setState(() => _goalDeadline = null),
                        ),
                    ],
                  ),
                ],
  ...
  Future<void> _submit() async {
    ...
    final goalTitle = _goalIsActive ? _goalTitleCtrl.text.trim() : null;
